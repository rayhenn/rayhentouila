    ...
    >
      ...
      <div className="absolute top-10 flex justify-between sm:w-[90%] lg:max-w-[1440px]">
        ...
        <div className="flex gap-10 text-[#e4ded7] sm:gap-12 md:gap-14 lg:gap-14">
          <Link
            href="https://www.instagram.com/rayhen.touila/"
            target="_blank"
      ...
      >
        ...
        >
          ...
          Axé sur la création de contenu destiné au web, projet se déroulant sur la Côte d&#39Azur ou en télétravail partout en France.
          </p>
        </motion.div>
      </div>
    </motion.section>
